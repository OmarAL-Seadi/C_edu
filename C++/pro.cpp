...
//int Num (lists data[],int &numberOfItems,int size);
int main()
{
...
string Name[size]={"ali","omar","abdullah","fahad","yaser"}; 
string Job[size]={"ff","gg","ee","hh","ll"};
string Main[7]{"Adding","Search ","Update ","Delete","Sort","Display","Stop"};
int Age[size]={1,2,3,4,5};
int ID[size]={1,2,3,4,5} ;
int sal[size]={1,2,3,4,5};
